...
namespace NuGet.CommandLine
{
    ...
    public class SetApiKeyCommand : Command
    {
        ...
        public override void ExecuteCommand()
        {
            ...
            SettingsUtility.SetEncryptedValueForAddElement(Settings, ConfigurationConstants.ApiKeys, source, apiKey);
            ...
            {
                SettingsUtility.SetEncryptedValueForAddElement(Settings, ConfigurationConstants.ApiKeys, NuGetConstants.DefaultSymbolServerUrl, apiKey);
