...
namespace NuGet.ProjectManagement
{
    public static class SourceControlUtility
    {
        ...
        {
            var value = SettingsUtility.GetValueForAddElement(settings, SolutionSection, DisableSourceControlIntegerationKey);
        ...
        {
            SettingsUtility.SetValueForAddElement(settings, SolutionSection, DisableSourceControlIntegerationKey, "true");
        }
