...
namespace NuGet.PackageManagement
{
    public class PackageRestoreConsent
    {
        ...
        public bool IsGrantedInSettings
        {
            get
            {
                var settingsValue = SettingsUtility.GetValueForAddElement(_settings, PackageRestoreSection, PackageRestoreConsentKey);
            ...
            set => SettingsUtility.SetValueForAddElement(_settings, PackageRestoreSection, PackageRestoreConsentKey, value.ToString(CultureInfo.InvariantCulture));
        }
        ...
        public bool IsAutomatic
        {
            get
            {
                var settingsValue = SettingsUtility.GetValueForAddElement(_settings, PackageRestoreSection, PackageRestoreAutomaticKey);
                return IsSet(settingsValue, IsGrantedInSettings);
            }
            set => SettingsUtility.SetValueForAddElement(_settings, PackageRestoreSection, PackageRestoreAutomaticKey, value.ToString(CultureInfo.InvariantCulture));
        }
